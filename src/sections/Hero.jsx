...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="mt-10 font-palanquin text-8xl max-sm:text[72px] max-sm:leading-[82px] font-bold text-yellow-50">
          <span className="xl:bg-zinc-900 xl:whitespace-nowrap relative z-9 pr-10 text-yellow-50">Novos Modelos</span>
          <br />
          <motion.span 
